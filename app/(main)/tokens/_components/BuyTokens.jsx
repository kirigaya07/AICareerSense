        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                {packages.map((pkg) => (
                    ...
                    >
                        <h3 className="font-bold text-lg">{pkg.description}</h3>
                        <p className="text-2xl font-bold text-blue-600">₹{pkg.amount}</p>
                        <p className="text-gray-600">{pkg.tokens.toLocaleString()} tokens</p>
                    </div>
                ))}
            </div>
            ...
            <button
                ...
                className={`w-full py-3 rounded-lg font-medium ${!selectedPackage || isLoading
            ...
            <p className="text-sm text-gray-500 mt-4">
                Note: Make sure Razorpay script is included in your layout:
                <br />
