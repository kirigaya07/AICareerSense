...
const features = [
    {
        ...
        description: "Get personalized career guidance using advanced AI technology"
    },
    {
        ...
        <div className="container mx-auto px-4 py-24">
            ...
            <div className="text-center mb-16">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                    Your AI-powered career development platform, designed to help you achieve your professional goals
                    through personalized guidance and cutting-edge tools.
                </p>
            </div>
                ...
                <CardContent className="p-8">
                    <div className="space-y-6">
                        ...
                        <p className="text-muted-foreground">
                            AspireAI combines artificial intelligence with career development expertise
                            to provide accessible, personalized professional guidance. We believe everyone
                            deserves access to high-quality career development tools and insights.
                        </p>
                    </div>
                </CardContent>
            </Card>
                ...
                <CardContent className="p-8">
                    ...
                    <div className="space-y-6">
                        <p className="text-muted-foreground text-center max-w-3xl mx-auto">
                            We leverage advanced AI models and machine learning algorithms to provide
                            personalized career guidance, resume optimization, and interview preparation.
                            Our platform continuously learns and adapts to provide the most relevant
