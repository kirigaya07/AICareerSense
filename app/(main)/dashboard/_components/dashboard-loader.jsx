        ...
        <div className="py-16 flex flex-col items-center justify-center">
            ...
            <div className="w-full max-w-3xl mx-auto space-y-4 px-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    {[...Array(4)].map((_, i) => (
                        <div key={i} className="h-28 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm p-3 space-y-3"
                        ...
                        {[...Array(10)].map((_, i) => (
                            <div key={i} className="w-full">
                                <div
                                    ...
                                    style={{
                                        height: `${Math.max(20, Math.min(100, 40 + Math.sin(i * 0.9) * 50))}%`,
                                        animationDelay: `${i * 0.1}s`
                                    }}
                                ></div>
                            </div>
