...
import { Shield, Lock, Eye, Database, Share2, Bell, Cookie, Scale } from "lucide-react";
    ...
    return (
        <div className="container mx-auto px-4 py-24">
            ...
            <div className="text-center mb-16">
                ...
                <h1 className="text-4xl font-bold gradient-title mb-4">Privacy Policy</h1>
            ...
            <Card className="mb-8">
                <CardContent className="p-6">
                    <p className="text-muted-foreground">
                        At AspireAI, we take your privacy seriously. This privacy policy explains how we collect,
                        use, and protect your personal information when you use our AI-powered career development platform.
                    </p>
                </CardContent>
            </Card>
                    ...
                    <CardContent>
                        <ul className="space-y-4 text-muted-foreground">
                            <li className="flex items-start gap-2">
                                ...
                                <span>To provide personalized career guidance and recommendations</span>
                            </li>
                            <li className="flex items-start gap-2">
