...
export default function TokenUsageChart({ transactions }) {
    ...
    if (chartData.labels.length === 0) {
        return (
            <div className="flex flex-col items-center justify-center h-64 bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-500 text-center">No token usage data available yet. Start using AI features to see your usage breakdown.</p>
            </div>
        );
    }
    ...
    return (
        <div className="bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold mb-4 text-blue-500">Token Usage Breakdown</h2>
            <div className="h-64">
